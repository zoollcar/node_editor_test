    ...
    if (nk_begin(ctx, "Overview", nk_rect(10, 10, 400, 600), window_flags))
    {
        ...
        if (show_app_about) // 关于弹出式窗口
        {
            ...
            if (nk_popup_begin(ctx, NK_POPUP_STATIC, "About", NK_WINDOW_CLOSABLE, s))
            {
                ...
                nk_label(ctx, "vdjkahsdgskgsjdnhjnjaaasssssassansjnjansjnajsnajnsjnajsnjansjnajsnjanjnsjjansjnajnsjanjsnajnsjanjsnjanjsnjansnja",  NK_TEXT_LEFT);
                nk_popup_end(ctx);
